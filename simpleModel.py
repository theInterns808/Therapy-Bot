...
audio_files_dir = 'data/emodb/wav'
...
for audio_file in audio_files:
    ...
    prediction = rec.predict(file_path)
    print(f"Prediction for {audio_file}: {prediction}")


print("\n\nPrediction:", rec.predict("test_recording_20240702_120157.wav"))

print("Prediction:", rec.predict("data/emodb/wav/10a02Lb.wav"))
